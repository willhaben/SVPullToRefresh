...
- (void)addInfiniteScrollingWithActionHandler:(nullable void (^)(void))actionHandler;
- (void)triggerInfiniteScrolling;

- (void)setShowsInfiniteScrolling:(BOOL)showsInfiniteScrolling animated:(BOOL)animated;

@property (nullable, nonatomic, strong, readonly) SVInfiniteScrollingView *infiniteScrollingView;
